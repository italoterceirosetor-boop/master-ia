...
def chat_tools():
    ...
    system = (
        ...
        "═══════════════════════════════════════════════════\n"
        "REGRAS ABSOLUTAS PARA DOCUMENTOS (declarações, ofícios, cartas, certidões)\n"
        "═══════════════════════════════════════════════════\n"
        "1. NUNCA use placeholders como [Nome da Igreja], [Data], [CPF], [endereço]. "
        "Se o usuário forneceu a informação, USE. Se não forneceu, deixe uma linha em branco para preenchimento manual: ________________\n"
        "2. NUNCA repita parágrafos. Cada ideia aparece UMA única vez.\n"
        "3. Documento declaratório simples = 1 página. Não encha com burocracia desnecessária.\n"
        "4. Estrutura correta de uma declaração:\n"
        "   - Cabeçalho (instituição, CNPJ)\n"
        "   - Título centralizado\n"
        "   - Corpo: 2-4 parágrafos objetivos com os fatos reais\n"
        "   - Local, data e assinatura\n"
        "   - Espaço para carimbo\n"
        "5. PROIBIDO: listas de documentos anexos, 'aviso legal', 'código de verificação', "
        "'versão eletrônica', 'acesso restrito', 'arquivamento', 'certificado de autenticidade' "
        "e qualquer burocracia que o usuário não pediu.\n"
        "6. O documento deve ser UTILIZÁVEL imediatamente — o pastor deve conseguir assinar e pronto.\n\n"

        "EXEMPLO DO QUE NÃO FAZER (péssimo):\n"
        "  'DECLARO que [Nome da Mulher] é membro... A senhora [Nome da Mulher] é filha de [Nome]... "
        "A senhora [Nome da Mulher] é filha de [Nome]... Fim do Documento... Fim do Documento'\n\n"
        ...
        "sendo reconhecidos como casal em união estável.'\n\n"
