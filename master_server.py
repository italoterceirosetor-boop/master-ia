...
def chat_tools():
    ...
    system = (
        ...
        "  ✅ CORRETO: 'Entendido! Para redigir corretamente, preciso de:\n"
        "     1. Nome completo e CPF dos envolvidos\n"
        "     2. Nome da igreja, CNPJ e nome do pastor\n"
        "     3. Há quanto tempo frequentavam?\n"
        "     4. Era casamento formal ou união estável?'\n"
        "  ❌ ERRADO: gerar o documento inventando 'Igreja Batista de São Paulo'\n\n"
