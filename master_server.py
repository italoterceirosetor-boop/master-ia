...
def gen_pdf(titulo, content, imagens=None, tema="padrao", uma_pagina=False, sem_circulos=False, subtitulo="", tamanho_fonte="normal", espacamento="normal", hero_altura="normal", mostrar_rodape=True):
    ...
    _top_margin   = _hero_band + 1.0*cm   # topMargin = altura do hero + margem mínima
    # sp_hero: Spacer negativo para subir o texto até o hero
    sp_hero       = -(_hero_band - 1.5*cm)
    # sp_after_hero: após o hero, pula para a área de conteúdo
    sp_after_hero = (_hero_band + 0.8*cm) if not uma_pagina else (_hero_band + 0.3*cm)
...
2. PYTHON AVANÇADO: use executar_python para:
   ...
   - Quando o usuário pedir para MODIFICAR um documento já gerado, use os parâmetros corretos:
